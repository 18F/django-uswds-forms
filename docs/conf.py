...
# -*- coding: utf-8 -*-
#
# django-uswds-forms documentation build configuration file, created by
...
htmlhelp_basename = 'django-uswds-formsdoc'
...
man_pages = [
    (master_doc, 'django-uswds-forms', 'django-uswds-forms Documentation',
     [author], 1)
]
